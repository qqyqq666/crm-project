...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveCreateActivityBtn").click(function () {
			...
			var name=$.trim($("#create-marketActivityName").val()); //去空格
	...
	function queryActivityByConditionForPage() {
		...
		$.ajax({
			...
			data:{
				name:name,   //要与后台controller中方法的形参名字保持一直
				owner:owner,
				startDate:startDate,
				endDate:endDate,
				pageNo:pageNo,
			...
			success:function (data) {
				...
				var htmlStr="";  //定义一个大字符串放数据
				$.each(data.activityList,function (index,obj) {  //index 下标 从0开始遍历
				...
				//覆盖显示，先清空再显示
				$("#tBody").html(htmlStr); //$("#tBody").append(htmlStr); 会不断追加
			}
		});
	}
